    ...
    try {
      const musicCommandsEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: '🔄 Autoplay', value: 'Включить или отключить автозапуск [ воспроизведение случайных песен ]' },
      ...
      const basicCommandsEmbed = new EmbedBuilder()
        ...
        .addFields(
          { name: '🏓 Ping', value: "Проверяет задержку бота" },
          { name: '🗑️ Clear', value: 'Очистить очередь песен на этом сервере' },
          { name: '⏱️ Time', value: 'Отображение текущего времени воспроизведения песни' },
